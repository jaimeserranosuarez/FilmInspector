...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text("FilmInspector"),
          actions: [
            IconButton(
              onPressed: () {
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => ListTitles(
                                      titulos: top250Movies,
                                      pagina: 'Top mejores 250 películas',
                                    )));
                      },
                      child: textos(context, 'Ver más', kTextColorPrinc,
                          FontWeight.w400, responsive.height(1.7)),
                    ...
                    child: GestureDetector(
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) => ListTitles(
                                      titulos: top250Series,
                                      pagina: 'Top Mejores series',
                                    )));
                      },
                      child: textos(context, 'Ver más', kTextColorPrinc,
                          FontWeight.w400, responsive.height(1.7)),
